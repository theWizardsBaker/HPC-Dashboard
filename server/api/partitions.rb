...
# get the modules
modules = system "ssh 128.206.234.6 'sinfo -a -O available,cpus,cpusload,freemem,cpusstate,cores,defaulttime,disk,memory,partition,time,threads' &> tmods.txt"
modules = `cat tpartion.txt`
